...
impl Command for Jump {
    ...
    fn run(&self, arguments: Vec<String>) -> CommandResult {
        ...
        if arguments[0] == "eq" {
            condition = arguments[0] == arguments[1];
        ...
        if arguments[0] == "gt" {
            condition = arguments[0].parse::<i64>().unwrap() > arguments[1].parse::<i64>().unwrap();
            label = Some(arguments[2].to_string());
        }
        if arguments[0] == "lt" {
            condition = arguments[0].parse::<i64>().unwrap() < arguments[1].parse::<i64>().unwrap();
        ...
        if arguments[0] == "t" {
            condition = !(arguments[0].is_empty()
                || arguments[0] == "0"
                || arguments[0] == "false"
                || arguments[0] == "no");
            label = Some(arguments[1].to_string());
        }
        if arguments[0] == "f" {
            condition = arguments[0].is_empty()
                || arguments[0] == "0"
